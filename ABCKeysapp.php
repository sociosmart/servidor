   ...
   <script src="js/sb-admin.min.js"></script>  
    ...
    setTimeout(function() 
    {
        $(".alertaquitar").fadeOut(1500);
            ...
            <!--Modales -->
  <!-- Edit Modal HTML -->
  <?php include("Modales/ModalEditKeyapp.php");?>
  <?php include("Modales/ModalAltaKeypp.php");?>
   <?php include("Modales/ModalEliminarKeyapp.php");?>
   <?php include("Modales/ModalLiberar.php");?>
  
  <script src="js/ABCKeysapp.js"></script>

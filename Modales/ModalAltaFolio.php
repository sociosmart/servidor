           ...
           <form action="" method="post">
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <input class="form-control" id="Prefijo" name="Prefijo" type="text" maxlength="5" aria-describedby="nameHelp" placeholder="Escribe" required="">
              </div>
              <div class="col-md-8">
                <label for="exampleInputLastName">DESCRIPCIÓN</label>
                <input class="form-control" id="Descripcion" name="Descripcion" type="text" aria-describedby="nameHelp" maxlength="50" placeholder="Escribe" required="">
              </div>
          </div>
           </div> 
           <div class="modal-body">

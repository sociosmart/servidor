...
<div id="Asigarpv" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form name="delete_product" id="delete_product">
          <div class="modal-header">            
            <h4 class="modal-title">ASIGANR PV</h4>
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          </div>
          <div class="modal-body">          
            <p>¿DESEA ASIGNAR PUNTOS DE VENTA AHORA?</p>
            <p class="text-warning"><small></small></p>
            <input class="form-control" id="ElIde" name="ElIde" type="text" aria-describedby="nameHelp" style="display: none;">
          </div>
          <div class="modal-footer">
        <button type="button"  data-dismiss="modal" class="btn btn-danger" id="modal-btn-si">SI</button>

  ...
  <form action="" method="post">
            ...
            <div class="row">
             ...
             <div class="table-responsive">
               <h2>PUNTOS ACUMULADOS POR ESTACION</h2>
    ...
    <tr >
      ...
      <th scope="col" width="20%">Cve</th>
       <th scope="col"width="15%">Estacion</th>
         <th scope="col"width="25%">Puntos</th>
...
<?php
     ...
     $rs= $conexion->Execute( "SELECT sum(PuntosAcumulados)AS numero,FK_Cve_PuntoDeVenta,nombrecomercial from t_movimientosacumulaciones 
...
?>
    <tr scope="row">          
                 ...
                 <td style="font-size: 12px;" class="contenido contenido4"  data-target="#ModalVerPuntosReporte1" data-toggle="modal"><?php      
                       echo  number_format($rs->fields['numero'], 2, '.', ''); ?>        
  ...
  var dataString = 'Estacion='+ Estacion+'&grupo='+ grupo+'&F_inicial='+ '<?php echo $F_inicial; ?>'+'&F_Final='+ '<?php echo $F_Final; ?>';//se guarda en una variable nueva para posteriormente pasarla al archivo
   ...
   // alert(dataString);
    ...
    $.ajax({ //metodo ajax
      ...
      url: "Modales/ModalVerPuntosDetalleEstacion.php", //la url adonde se va a mandar la cadena a buscar
      data: dataString,
      cache: false,

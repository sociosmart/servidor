...
var ctx=document.getElementById("myAreaChart"),
	...
	datasets:[{label:"Sessions",lineTension:.3,
	...
	pointHitRadius:20,
	pointBorderWidth:2,
	data:[1e4,30162,26263,18394,18287,28682,31274,33259,25849,24159,32651,31984,32555]}]},
	options:{scales:{xAxes:[{time:{unit:"date"},
	gridLines:{display:!1},
	ticks:{maxTicksLimit:7}}],
	yAxes:[{ticks:{min:0,//minimo en y
	max:4e4, //maximo en Y
	maxTicksLimit:9},//lineas horizontales

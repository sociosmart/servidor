...
function read(a)
{
    ...
    for(i in arr){
        ...
        document.getElementById("mapo").innerHTML= "<b><u>USUARIO:</u> " + arr[0] + "</b>";    
        document.getElementById("mact").innerHTML= "<b><u>Mã chi tiết:</u> " + arr[1] + "</b>";    
        document.getElementById("soluong").innerHTML= "<b><u>Số lượng:</u> " + arr[2] + "</b>";    
    }
